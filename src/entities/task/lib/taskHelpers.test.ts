...
describe('taskHelpers', () => {
  describe('convertFormToTask', () => {
    beforeEach(() => {
      vi.spyOn(timeHelpers, 'getDueString').mockReturnValue('2024-04-12 в 10:00')
    ...
    it('should add duration if timeEnd is specified', () => {
      const form = { content: 'Task', date: '2024-04-12', timeStart: '10:00', timeEnd: '11:00' }
      const result = convertFormToTask(form)
  ...
  describe('convertTaskToForm', () => {
    ...
    it('should correctly convert Task to ITaskForm', () => {
      const task = createMockTask({
        ...
        due: { date: '2024-04-12', datetime: '2024-04-12T10:00:00Z', isRecurring: false, string: '2024-04-12' },
  ...
  describe('convertDndToTask', () => {
    beforeEach(() => {
      vi.spyOn(timeHelpers, 'getDueString').mockImplementation((date, time) => 
        `${date} в ${time || ''}`)
    })
